...
这个例子是[示例 2.1]({{ '/tutorials/2.1/' | relative_url }})的DFT类似物，与[示例 3.1]({{ '/tutorials/3.1/' | relative_url }})和[示例 4.1]({{ '/tutorials/4.1/' | relative_url }})相同，除了我们使用Quantum Espresso来松弛结构（而不是CASTEP或VASP）。
...
**上一页：** [示例 4.1: VASP 100 GPa下碳的自由搜索]({{ '/tutorials/4.1/' | relative_url }}) | **下一页：** [示例 5.2: Quantum Espresso 100 GPa下氢的分子单元搜索]({{ '/tutorials/5.2/' | relative_url }})
