---
title: "示例 3.4: CASTEP gamma-B28模块化分解"
layout: single
classes: wide
lang: zh
lang-ref: example-3-4
sidebar:
  nav: "docs"
---

**下载输入文件:**
[<i class="fas fa-download"></i> B.cell]({{ '/assets/examples/3.4/B.cell' | relative_url }}){: .btn .btn--primary .btn--small}
[<i class="fas fa-download"></i> B.param]({{ '/assets/examples/3.4/B.param' | relative_url }}){: .btn .btn--primary .btn--small}

我们可以使用模块性检测算法来分析在[示例3.3]({{ '/zh/tutorials/3.3/' | relative_url }})中识别的`Pnnm` γ-B结构，该算法应用于原子接触的复杂网络。有关更多详细信息，请参阅以下论文[S. E. Ahnert, W. P. Grant, and C. J. Pickard "Revealing and exploiting hierarchical material structure through complex atomic networks."  _npj Computational Materials_, 2017, **3**, 35.](https://doi.org/10.1038/s41524-017-0035-x)
...
利用这种结构分解，我们可以通过随机放置这些D2h单元到相同的固定晶胞中来快速重新发现它。
...
这次γ-B结构在187次尝试中被定位了3次。

---

**上一页:** [示例 3.3: CASTEP gamma-B28固定晶胞搜索]({{ '/zh/tutorials/3.3/' | relative_url }}) | **下一页:** [示例 4.1: VASP 100 GPa下碳的自由搜索]({{ '/zh/tutorials/4.1/' | relative_url }})
