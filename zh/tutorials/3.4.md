...
我们可以使用模块性检测算法来分析在[示例3.3]({{ '/tutorials/3.3/' | relative_url }})中识别的`Pnnm` γ-B结构，该算法应用于原子接触的复杂网络。有关更多详细信息，请参阅以下论文[S. E. Ahnert, W. P. Grant, and C. J. Pickard "Revealing and exploiting hierarchical material structure through complex atomic networks."  _npj Computational Materials_, 2017, **3**, 35.](https://doi.org/10.1038/s41524-017-0035-x)
...
**上一页:** [示例 3.3: CASTEP gamma-B28固定晶胞搜索]({{ '/tutorials/3.3/' | relative_url }}) | **下一页:** [示例 4.1: VASP 100 GPa下碳的自由搜索]({{ '/tutorials/4.1/' | relative_url }})
