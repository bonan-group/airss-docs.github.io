...
在这个例子中，我们探索100 GPa下的氢。此例子与[示例 3.2]({{ '/zh/tutorials/3.2/' | relative_url }})相同，只是我们使用Quantum Espresso进行结构松弛。
...
与[示例 5.1]({{ '/zh/tutorials/5.1/' | relative_url }})一样，您需要安装Quantum Espresso的`pw.x`二进制文件并将其放在您的路径中。
...
**上一页：** [示例 5.1: Quantum Espresso 100 GPa下碳的自由搜索]({{ '/zh/tutorials/5.1/' | relative_url }}) | **下一页：** [示例 6.1: 使用Python/ASE的Lennard-Jones固体]({{ '/zh/tutorials/6.1/' | relative_url }})
