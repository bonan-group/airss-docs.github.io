...
[`Al.cell`](/assets/examples/1.5/Al.cell){: .btn .btn--primary .btn--small}
[`Al.pp`](/assets/examples/1.5/Al.pp){: .btn .btn--primary .btn--small}
...
It is clear, for this problem, that the use of symmetry explored in [Example 1.4](/tutorials/1.4/) is recommended.

---

**Previous:** [Example 1.4: Lennard-Jones Cluster with 38 Atoms and Symmetry](/tutorials/1.4/) | **Next:** [Example 1.6: Lennard-Jones Cluster LJ56, using LJ55 Icosahedral Core](/tutorials/1.6/)
