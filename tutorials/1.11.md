...
[`AB.cell`](/assets/examples/1.11/AB.cell){: .btn .btn--primary .btn--small}
[`AB.pp`](/assets/examples/1.11/AB.pp){: .btn .btn--primary .btn--small}
...
**Previous:** [Example 1.10: Lennard-Jones Ternary with Variable Composition](/tutorials/1.10/) | **Next:** [Example 1.12: Lennard-Jones Binary Nanowire in a Nanotube](/tutorials/1.12/)
