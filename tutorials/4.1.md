...
[`C2.cell`]({{ '/assets/examples/4.1/C2.cell' | relative_url }}){: .btn .btn--primary .btn--small}
[`C2.INCAR`]({{ '/assets/examples/4.1/C2.INCAR' | relative_url }}){: .btn .btn--primary .btn--small}
