...
[`C2.cell`](/assets/examples/4.1/C2.cell){: .btn .btn--primary .btn--small}
[`C2.INCAR`](/assets/examples/4.1/C2.INCAR){: .btn .btn--primary .btn--small}
...
The search is a repeat of that performed in [Example 2.1](/tutorials/2.1/), except this time the search will be performed using the VASP code. First create a `C2.POTCAR` file. The `airss.pl` script is used in the usual way, except the `-vasp` flag it set.
...
**Previous:** [Example 3.4: CASTEP gamma-B28 with Modular Decomposition](/tutorials/3.4/) | **Next:** [Example 5.1](/tutorials/5.1/)
