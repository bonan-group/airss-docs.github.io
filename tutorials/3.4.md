...
[`B.cell`](/assets/examples/3.4/B.cell){: .btn .btn--primary .btn--small}
[`B.param`](/assets/examples/3.4/B.param){: .btn .btn--primary .btn--small}

We can analyse the `Pnnm` γ-B structure identified in [Example 3.3](/tutorials/3.3/) using a modularity detection algorithm as
...
**Previous:** [Example 3.3: CASTEP Fixed Cell Search for gamma-B28](/tutorials/3.3/) | **Next:** [Example 4.1: VASP Free Search for Carbon at 100 GPa](/tutorials/4.1/)
