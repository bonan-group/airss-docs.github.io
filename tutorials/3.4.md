---
title: "Example 3.4: CASTEP gamma-B28 with Modular Decomposition"
layout: single
classes: wide
lang: en
...
We can analyse the `Pnnm` γ-B structure identified in [Example 3.3]({{ '/tutorials/3.3/' | relative_url }}) using a modularity detection algorithm as
...
**Previous:** [Example 3.3: CASTEP Fixed Cell Search for gamma-B28]({{ '/tutorials/3.3/' | relative_url }}) | **Next:** [Example 4.1: VASP Free Search for Carbon at 100 GPa]({{ '/tutorials/4.1/' | relative_url }})
