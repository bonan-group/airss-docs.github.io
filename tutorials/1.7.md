...
[`Al.cell`](/assets/examples/1.7/Al.cell){: .btn .btn--primary .btn--small}
[`Al.pp`](/assets/examples/1.7/Al.pp){: .btn .btn--primary .btn--small}
...
**Previous:** [Example 1.6: Lennard-Jones Cluster LJ56, using LJ55 Icosahedral Core](/tutorials/1.6/) | **Next:** [Example 1.8: Binary Lennard-Jones](/tutorials/1.8/)
