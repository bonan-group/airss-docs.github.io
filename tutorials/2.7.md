...
[`CH4.cell`]({{ '/assets/examples/2.7/CH4.cell' | relative_url }}){: .btn .btn--primary .btn--small}
[`CH4.lib`]({{ '/assets/examples/2.7/CH4.lib' | relative_url }}){: .btn .btn--primary .btn--small}
