...
[`CH4.cell`](/assets/examples/2.7/CH4.cell){: .btn .btn--primary .btn--small}
[`CH4.lib`](/assets/examples/2.7/CH4.lib){: .btn .btn--primary .btn--small}
...
**Previous:** [Example 2.6: GULP SiO2 Cluster Search](/tutorials/2.6/) | **Next:** [Example 3.1: CASTEP Free Search for Carbon at 100 GPa](/tutorials/3.1/)
