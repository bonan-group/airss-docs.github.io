...
[`AB.cell`](/assets/examples/1.13/AB.cell){: .btn .btn--primary .btn--small}
[`AB.pp`](/assets/examples/1.13/AB.pp){: .btn .btn--primary .btn--small}
...
**Previous:** [Example 1.12: Lennard-Jones Binary Nanowire in a Nanotube](/tutorials/1.12/) | **Next:** [Example 2.1: GULP Free Search for Carbon at 100 GPa](/tutorials/2.1/)
