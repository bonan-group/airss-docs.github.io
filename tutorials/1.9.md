...
[`AB.cell`](/assets/examples/1.9/AB.cell){: .btn .btn--primary .btn--small}
[`AB.pp`](/assets/examples/1.9/AB.pp){: .btn .btn--primary .btn--small}
...
**Previous:** [Example 1.8: Lennard-Jones Binary with Fixed Composition](/tutorials/1.8/) | **Next:** [Example 1.10: Lennard-Jones Ternary with Variable Composition](/tutorials/1.10/)
