---
title: "Example 1.8: Lennard-Jones Binary with Fixed Composition"
layout: single
classes: wide
lang: en
...
**Previous:** [Example 1.7: Lennard-Jones Surface Adatom]({{ '/tutorials/1.7/' | relative_url }}) | **Next:** [Example 1.9: Lennard-Jones Binary with Variable Composition]({{ '/tutorials/1.9/' | relative_url }})
