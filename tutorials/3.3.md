...
[`B.cell`](/assets/examples/3.3/B.cell){: .btn .btn--primary .btn--small}
[`B.param`](/assets/examples/3.3/B.param){: .btn .btn--primary .btn--small}
...
**Previous:** [Example 3.2: CASTEP Hydrogen at 100 GPa with Molecular Units](/tutorials/3.2/) | **Next:** [Example 3.4: CASTEP gamma-B28 with Modular Decomposition](/tutorials/3.4/)
