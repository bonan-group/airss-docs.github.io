...
[`Al.cell`](/assets/examples/1.6/Al.cell){: .btn .btn--primary .btn--small}
[`Al.pp`](/assets/examples/1.6/Al.pp){: .btn .btn--primary .btn--small}
...
**Previous:** [Example 1.5: Lennard-Jones Cluster with 38 Atoms and RASH](/tutorials/1.5/) | **Next:** [Example 1.7: Lennard-Jones Surface with Adatom](/tutorials/1.7/)
