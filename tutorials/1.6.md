---
title: "Example 1.6: Lennard-Jones Cluster LJ56, using LJ55 Icosahedral Core"
layout: single
classes: wide
lang: en
...
**Previous:** [Example 1.5: Lennard-Jones Cluster with 38 Atoms and RASH]({{ '/tutorials/1.5/' | relative_url }}) | **Next:** [Example 1.7: Lennard-Jones Surface with Adatom]({{ '/tutorials/1.7/' | relative_url }})
