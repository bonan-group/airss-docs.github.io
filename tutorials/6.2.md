...
[`Si.cell`](/assets/examples/6.2/Si.cell){: .btn .btn--primary .btn--small}
[`relax.py`](/assets/examples/6.2/relax.py){: .btn .btn--primary .btn--small}
...
**Previous:** [Example 6.1: Lennard-Jones Solid using Python/ASE](/tutorials/6.1/)
