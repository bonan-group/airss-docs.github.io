...
We revisit this same carbon example using density-functional theory in [3.1]({{ '/tutorials/3.1/' | relative_url }})/[4.1]({{ '/tutorials/4.1/' | relative_url }})/[5.1]({{ '/tutorials/5.1/' | relative_url }})
(using different DFT codes).

---

**Previous:** [Example 1.13: Lennard-Jones Binary Interface]({{ '/tutorials/1.13/' | relative_url }}) | **Next:** [Example 2.2: GULP Coordination Constrained Carbon Search]({{ '/tutorials/2.2/' | relative_url }})
