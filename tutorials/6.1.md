...
[`Al.cell`]({{ '/assets/examples/6.1/Al.cell' | relative_url }}){: .btn .btn--primary .btn--small}
[`relax.py`]({{ '/assets/examples/6.1/relax.py' | relative_url }}){: .btn .btn--primary .btn--small}
