---
title: "Example 1.2: Lennard-Jones Cluster with 13 Atoms"
layout: single
classes: wide
lang: en
lang-ref: example-1-2
sidebar:
  nav: "docs"
---

**Download input files:**
[<i class="fas fa-download"></i> Al.cell]({{ '/assets/examples/1.2/Al.cell' | relative_url }}){: .btn .btn--primary .btn--small}
[<i class="fas fa-download"></i> Al.pp]({{ '/assets/examples/1.2/Al.pp' | relative_url }}){: .btn .btn--primary .btn--small}
...
**Previous:** [Example 1.1: Lennard-Jones Solid with 8 Atoms]({{ '/tutorials/1.1/' | relative_url }}) | **Next:** [Example 1.3: Lennard-Jones Clusters with 2-13 Atoms]({{ '/tutorials/1.3/' | relative_url }})
