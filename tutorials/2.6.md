...
[`SiO2.cell`]({{ '/assets/examples/2.6/SiO2.cell' | relative_url }}){: .btn .btn--primary .btn--small}
[`SiO2.lib`]({{ '/assets/examples/2.6/SiO2.lib' | relative_url }}){: .btn .btn--primary .btn--small}
