...
[`C.cell`](/assets/examples/2.2/C.cell){: .btn .btn--primary .btn--small}
[`C.lib`](/assets/examples/2.2/C.lib){: .btn .btn--primary .btn--small}
...
**Previous:** [Example 2.1: GULP Free Search for Carbon at 100 GPa](/tutorials/2.1/) | **Next:** [Example 2.3: GULP C20 Fullerene Cluster Search](/tutorials/2.3/)
